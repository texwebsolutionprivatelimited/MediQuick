...
// We need to distribute exactly 600 products across categories
// To get 600 products, let's generate multiple variations for each subcategory name
  ...
  CATEGORY_MAP.forEach((catObj) => {
    catObj.subcategories.forEach((subcat) => {
      subcat.names.forEach((baseName, index) => {
        ...
        // Variation tag (e.g. Extra, Forte, Mild, Premium, Daily, Active)
        let variation = "";
        if (r > 0) {
